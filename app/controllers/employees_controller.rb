class EmployeesController < ApplicationController
  ...
  def create
    ...
    create_invitation = organization_invitations.create_organization_invitation('org_2vLMkZCAXOv6VCUPj24tb6Md5OV', create_organization_invitation_request: {role: 'org:carbon_credits_employee',email_address: params[:email_address]})
